...
use App\Repositories\Admin\WebsiteTemplateRepository;
...
class WebsiteTemplateController extends Controller
{
    ...
    {
        $this->repo = new WebsiteTemplateRepository;
    }
    ...
    {
        if(request()->isMethod('get')) return view('admin.website.template.list');
