...
use App\Repositories\Admin\SeoCaseRepository;

class SeoCaseController extends Controller
{
    //
    private $repo;
    public function __construct()
    {
        $this->repo = new SeoCaseRepository;
    }
    ...
    {
        return view('admin.seo.case.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('admin.seo.case.list');
