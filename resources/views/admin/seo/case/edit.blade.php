...
@section('title')
    @if($operate == 'create') 添加SEO案例 @else 编辑SEO案例 @endif
@endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/seo/list')}}"><i class="fa "></i> SEO案例列表</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加SEO案例 @else 编辑SEO案例 @endif</h3>
            ...
            <div class="box-body">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="type" value="1"
                                               @if($operate == 'create' || ($operate == 'edit' && $data->type == 1)) checked="checked" @endif> 百度
                                    </label>
                                </div>
                            </button>
                            <button type="button" class="btn">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="type" value="2"
                                               @if($operate == 'edit' && $data->type == 2) checked="checked" @endif> 手机百度
                                    </label>
                                </div>
                            </button>
                            <button type="button" class="btn">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="type" value="2"
                                               @if($operate == 'edit' && $data->type == 3) checked="checked" @endif> 360搜索
                                    </label>
                                </div>
                            </button>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div><input type="text" class="form-control" name="keywords" placeholder="请输入关键字" value="{{$data->keywords or ''}}"></div>
                    </div>
                </div>
                {{--企业名称--}}
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div><input type="text" class="form-control" name="name" placeholder="请输入企业名称" value="{{$data->name or ''}}"></div>
                    </div>
                </div>
                {{--域名--}}
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div><input type="text" class="form-control" name="link_url" placeholder="域名" value="{{$data->link_url or ''}}"></div>
                    </div>
                </div>
                {{--说明--}}
                <div class="form-group">
                ...
                {{--初始排名--}}
                <div class="form-group">
                    <label class="control-label col-md-2">初始排名</label>
                    <div class="col-md-8 ">
                        <div><input type="text" class="form-control" name="custom[previous_rank]" placeholder="请输入初始排名" value="{{$data->custom->previous_rank or ''}}"></div>
                    </div>
                </div>
                {{--当前排名--}}
                <div class="form-group">
                    <label class="control-label col-md-2">当前排名</label>
                    <div class="col-md-8 ">
                        <div><input type="text" class="form-control" name="custom[after_rank]" placeholder="请输入当前排名" value="{{$data->custom->after_rank or ''}}"></div>
                    </div>
                </div>
                {{--目录--}}
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success" id="edit-seo-submit"><i class="fa fa-check"></i> 提交</button>
...
<script>
    $(function() {
        ...
        // 添加or编辑
        $("#edit-seo-submit").on('click', function() {
            var options = {
                url: "{{url('/admin/seo/case/edit')}}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/seo/case/list')}}";
                    }
                }
            };
        ...
        $('#menus').select2({
            ajax: {
                url: "{{url('/admin/seo/case/select2_menus')}}",
                dataType: 'json',
                delay: 250,
