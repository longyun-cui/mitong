            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success" id="edit-template-submit"><i class="fa fa-check"></i> 提交</button>
...
<script>
    $(function() {
        ...
        $("#edit-template-submit").on('click', function() {
            var options = {
                url: "{{url('/admin/website/template/edit')}}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/website/template/list')}}";
                    }
                }
            };
        ...
        $('#menus').select2({
            ajax: {
                url: "{{url('/admin/website/template/select2_menus')}}",
                dataType: 'json',
                delay: 250,
